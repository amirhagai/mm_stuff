...
data_root = '/data/with-large-vehicle/'

backend_args = None

leave_original_chroma = False
...
train_pipeline = [
    ...
    dict(type='InjectLargeVehicleData', prob=injection_prob,
         base_path="/data/split_ss_dota/train_injected_container",
         injection_type="ycbcr",
         random_alpha_y_channel=random_alpha_y_channel,
         leave_original_chroma=leave_original_chroma),
