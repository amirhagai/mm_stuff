_base_ = [
    './__base_16_classes__/default_runtime.py', './__base_16_classes__/schedule_3x.py',
    './__base_16_classes__/dota_rr_test_no_ann.py'
]
...
test_dataloader = dict(batch_size=8, num_workers=9)
experiment_name = 'test_no_annotations'
