...
class ImgDataPreprocessorContrastive(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False, key: str = 'inputs') -> Union[dict, list]:
...
@MODELS.register_module()
class DetDataPreprocessorContrastive(ImgDataPreprocessorContrastive):
    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        return {'inputs': inputs, 'transformed': inputs_transformed,  'data_samples': data_samples}
