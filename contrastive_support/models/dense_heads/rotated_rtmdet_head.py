...
from .rtmdet_head import RTMDetHeadContrastive
...
class RotatedRTMDetHeadContrastive(RTMDetHeadContrastive):
...
@MODELS.register_module()
class RotatedRTMDetSepBNHeadContrastive(RotatedRTMDetHeadContrastive):
